...
module.exports = class Query
  ...
  __error__: (promise, err) ->
    caboose_model.metric_logger.log('mongo_error', 1) if caboose_model.metric_logger?
    promise.error(err)

  __complete__: (promise, value) ->
    caboose_model.metric_logger.log('mongo_query', (new Date() - @start)) if caboose_model.metric_logger?
