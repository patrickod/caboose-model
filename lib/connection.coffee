...
Model = require './model'
MetricLogger = require './metric_logger'
...
module.exports = class Connection
  ...
  @create: (connection_name = 'default', callback) ->
    ...
    # Set up the metric logger if we don't have one already
    if caboose_model.configs.graphite_api_key? and not caboose_model.metric_logger
      caboose_model.metric_logger = new MetricLogger(caboose_model.configs.graphite_api_key)
